...
public class register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(check_email.equals("true")){response.sendRedirect("register.jsp?reg=emailfalse");}else{
                //Insert new user to Database
                insertToDatabase insertuser = new insertToDatabase();
                insertuser.InsertUsers(connectionPool, uname, email, pass, country_code);
